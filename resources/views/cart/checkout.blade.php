...
<div class="container">
    ...
    <div class="pull-right">
        <a href="javascript:view_po()" class="btn btn-warning">พิมพ์ใบสั่งซื้อ</a>
        <a href="javascript:complete()" class="btn btn-primary" target="_blank"><i class="fa fa-check"></i> จบการขาย</a>
    </div>
</div>
<script type="text/javascript">
    function view_po() {
        window.open(
            "{{ URL::to('cart/viewpo') }}?cust_name=" + $('#cust_name').val() + '&cust_email=' + $('#cust_email').val(),
            "_blank",
          );
    }
    ...
    function complete() {
        window.open(
            "{{ URL::to('cart/complete') }}?cust_name=" + $('#cust_name').val() + '&cust_email=' + $('#cust_email').val(),
            "_blank",
          );
